...
export const idlService = IDL.Service({
  ...
  'addImageToNote' : IDL.Func([IDL.Text, IDL.Text], [Note], []),
  ...
  'removeImageFromNote' : IDL.Func([IDL.Text, IDL.Text], [Note], []),
  'saveCallerUserProfile' : IDL.Func([UserProfile], [], []),
  'searchNotes' : IDL.Func([IDL.Text], [IDL.Vec(Note)], ['query']),
  'togglePin' : IDL.Func([IDL.Text], [Note], []),
  'updateNote' : IDL.Func([IDL.Text, IDL.Text, IDL.Text], [Note], []),
});
