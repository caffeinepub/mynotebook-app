...
export class Backend implements backendInterface {
    ...
    async addImageToNote(arg0: string, arg1: string): Promise<Note> {
        if (this.processError) {
            try {
                const result = await this.actor.addImageToNote(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async removeImageFromNote(arg0: string, arg1: string): Promise<Note> {
        if (this.processError) {
            try {
                const result = await this.actor.removeImageFromNote(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async togglePin(arg0: string): Promise<Note> {
        if (this.processError) {
            try {
    ...
    async updateNote(arg0: string, arg1: string, arg2: string): Promise<Note> {
        if (this.processError) {
            try {
